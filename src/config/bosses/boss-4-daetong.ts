...
export const BOSS_4 = {
  id: 'B4',
  name: '대통 포병 대장',
  hp: 1000,                     // §10.5 · §14.1 보스 HP 원값 3850
      ...
      patterns: [
        {
          ...
          onImpact: {
            name: '폭발 링',
            kind: 'ring', bullet: 'P4',
            count: 6,             // 각 폭발 지점의 링 (발). §10.5 원값 8
        ...
        },
        {
          ...
          count: 20,               // 발. §10.5 원값 12
          durationSec: 2,      // 낙하에 걸리는 시간 (s). §10.5 원값 2.4
      ...
      patterns: [
        {
          ...
          // 계속 지워진다」로 만든다.
          kind: 'mortar',
          count: 10,               // 예고 원 (개). §10.5 원값 6
          telegraphSec: PATTERN_MORTAR_TELEGRAPH_SEC, // §6.2 곡사 착탄 예고 원은 고정이다
          radiusU: 90,            // §10.5 예고 원 반경 (u)
          sequentialSec: 0.3,    // 순차 표시 간격 (s). §10.5 원값 0.4
        ...
        },
        {
          ...
          intervalSec: 0.5,      // 연사 간격 (s). §10.5 원값 0.6
          repeat: 5,              // 발수. §10.5 원값 3
        ...
        },
        {
          ...
          parts: [
            ...
            },
            {
              ...
              // §10.5 페이즈 1과 같은 편성이다
              kind: 'barrage', bullet: 'P8',
              count: 30,           // 발. §10.5 원값 12
              durationSec: 2.0,  // 낙하에 걸리는 시간 (s). §10.5 원값 2.4
