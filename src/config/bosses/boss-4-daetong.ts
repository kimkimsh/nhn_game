  ...
  phases: [
    {
      ...
      patterns: [
        ...
        {
          name: '불화살 비',
          // §10.5 상단 전역에서 불화살 12발이 순차 낙하, 0.2초 간격. 착탄 시 장판 생성은 P8
          ...
          count: 12,              // §10.5 12발
          durationSec: 2.4,       // §10.5 12발 × 0.2초 간격 (s)
